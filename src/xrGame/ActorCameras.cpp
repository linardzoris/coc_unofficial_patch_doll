...
// HUD FOV Update --#SM+#--
    ...
    {
        auto pItem = smart_cast<CHudItem*>(this->inventory().ActiveItem());
        auto pDev = smart_cast<CHudItem*>(this->inventory().ItemFromSlot(DETECTOR_SLOT));
