...
void CEnvDescriptor::load(CEnvironment& environment, CInifile& config)
{
    ...
    m_cSwingDesc[0].amp1 = config.line_exist(m_identifier.c_str(), "swing_normal_amp1") ?
        config.r_float(m_identifier.c_str(), "swing_normal_amp1") :
        pSettings->r_float("details_params", "swing_normal_amp1");
    m_cSwingDesc[0].amp2 = config.line_exist(m_identifier.c_str(), "swing_normal_amp2") ?
        config.r_float(m_identifier.c_str(), "swing_normal_amp2") :
        pSettings->r_float("details_params", "swing_normal_amp2");
    m_cSwingDesc[0].rot1 = config.line_exist(m_identifier.c_str(), "swing_normal_rot1") ?
        config.r_float(m_identifier.c_str(), "swing_normal_rot1") :
        pSettings->r_float("details_params", "swing_normal_rot1");
    m_cSwingDesc[0].rot2 = config.line_exist(m_identifier.c_str(), "swing_normal_rot2") ?
        config.r_float(m_identifier.c_str(), "swing_normal_rot2") :
        pSettings->r_float("details_params", "swing_normal_rot2");
    m_cSwingDesc[0].speed = config.line_exist(m_identifier.c_str(), "swing_normal_speed") ?
        config.r_float(m_identifier.c_str(), "swing_normal_speed") :
        pSettings->r_float("details_params", "swing_normal_speed");
    // fast
    m_cSwingDesc[1].amp1 = config.line_exist(m_identifier.c_str(), "swing_fast_amp1") ?
        config.r_float(m_identifier.c_str(), "swing_fast_amp1") :
        pSettings->r_float("details_params", "swing_fast_amp1");
    m_cSwingDesc[1].amp2 = config.line_exist(m_identifier.c_str(), "swing_fast_amp2") ?
        config.r_float(m_identifier.c_str(), "swing_fast_amp2") :
        pSettings->r_float("details_params", "swing_fast_amp2");
    m_cSwingDesc[1].rot1 = config.line_exist(m_identifier.c_str(), "swing_fast_rot1") ?
        config.r_float(m_identifier.c_str(), "swing_fast_rot1") :
        pSettings->r_float("details_params", "swing_fast_rot1");
    m_cSwingDesc[1].rot2 = config.line_exist(m_identifier.c_str(), "swing_fast_rot2") ?
        config.r_float(m_identifier.c_str(), "swing_fast_rot2") :
        pSettings->r_float("details_params", "swing_fast_rot2");
    m_cSwingDesc[1].speed = config.line_exist(m_identifier.c_str(), "swing_fast_speed") ?
        config.r_float(m_identifier.c_str(), "swing_fast_speed") :
        pSettings->r_float("details_params", "swing_fast_speed");
